package com.lzw.face.exception;
...
public class FaceException extends RuntimeException {
    ...
    private static final long serialVersionUID = 4139717392740197893L;

    /**
     * Constructs an <code>ResourceNotExistException</code> with no
     * detail message.
     */
